# Purpose: Adds debugging output.

# What it does: Shows SMTP conversation with the server using set_debuglevel(1).

# Use: Useful for seeing the raw SMTP messages exchanged with the mail server.
