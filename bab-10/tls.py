# Purpose: Demonstrates how to send an email using TLS encryption.

# What it does:

# Connects using SMTP.

# Checks if STARTTLS is supported and negotiates a secure connection using ssl.

# Sends the message securely.
