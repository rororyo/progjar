# Purpose: Demonstrates how to use ESMTP extensions, especially message size.

# What it does:

# Uses EHLO to detect server capabilities.

# Checks if the message is too large.

# Fallback: Uses HELO if EHLO fails.
