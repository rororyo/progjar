# Purpose: Demonstrates how to send an email after logging in with a username and password.

# What it does:

# Prompts user for email login credentials.

# Calls SMTP.login() to authenticate before sending.
